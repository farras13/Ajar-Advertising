 <!-- <div id="nav" class="mx-4 blog-header navbar-fixed-top">
 	<header class=" py-2 px-5">
 		<div class="row flex-nowrap justify-content-between align-items-center">
 			<div class="col-4 pt-1">
 			</div>
 			<div class="col-4 text-center">
 				<a href="<?php echo site_url() ?>/Home"><img class="logo-header"
 			...
 			<div class="col-4 d-flex justify-content-end align-items-center">
 				...
 				<a class="btn btn-grad-warning btn-rounded px-4 fz-1 mr-3" href="<?php echo site_url() ?>/Login">
 					Start Now</a>
 				<a class="text-blue border-left pl-3 text-decoration-none mr-4"
 	...
 	<div class="nav-scroller py-1 mb-2 border-top border-2">
 		<nav class="nav d-flex justify-content-center ">
 			<a class="px-4 py-1 text-muted text-decoration-none" href="<?php echo site_url() ?>/paket">Paket
 				Artikel</a>
 			<a class="px-4 py-1 text-muted text-decoration-none" href="<?php echo site_url() ?>/paket">Paket
 				Interview</a>
 			<a class="px-4 py-1 text-muted text-decoration-none"
 				href="<?php echo site_url() ?>/Home/Payment">Afiliasi</a>
 			<a class="px-4  py-1 text-muted text-decoration-none"
 				href="<?php echo site_url() ?>/Home/Privacy">Promo</a>
 			<a class="px-4  py-1 text-muted text-decoration-none" href="<?php echo site_url() ?>/Home/Faq">Blog</a>
 		</nav>
 	</div>
 </div> -->

 <nav class="navbar navbar-expand-lg navbar-light blog-header py-3">
