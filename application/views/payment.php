                        ...
                        <div class="carousel-inner h-50">
                            <div class="carousel-item active h-75">
                                <p>Lorem Ipsum adalah contoh teks atau
                                    dummy dalam industri percetakan dan
                                    penataan huruf atau typesetting</p>
                            </div>
                ...
                <div class="col-md-8 pt-5 bg-white">
                    <div class="container px-5">
                            ...
                            <div class="col-md-5 payment-radio">
                                ...
                                <p>
                                    <span class="input-group-addon">
                                        <input name="payment" type="radio">
                                        <img class="radio-img"
                                            src="http://mnctrijaya.com/uploads/news/bank_mandiri.jpg">
                                    </span>
                                </p>
                                <p>
                                    <span class="input-group-addon">
                                        <input name="payment" type="radio">
                                        <img class="radio-img"
                                            src="http://chandra.my.id/wp-content/uploads/2012/07/logo-bank-bca.jpg">
                                    </span>
                                </p>
                                <p>
                                    <span class="input-group-addon">
                        ...
                        <div class="col-md-12 w-100 text-right mt-4">
                            <button class=" btn btn-abbys px-5 py-2 font-weight-bold">PAY NOW</button>
                        </div>
